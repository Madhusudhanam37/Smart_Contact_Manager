...
public class HomeController {
	...
	//Registering HANDLER
		...
		public String registeringHandler(@Valid @ModelAttribute("user") User user,BindingResult bindingResult,@RequestParam(value = "agreement",defaultValue = "false") boolean agreement,Model model,HttpSession session) {
